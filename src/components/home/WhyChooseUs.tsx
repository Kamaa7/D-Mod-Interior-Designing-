        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center group">
            <div className="w-20 h-20 bg-sattva-orange/10 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:bg-sattva-orange group-hover:scale-110 transition-all duration-300">
              <CheckCircle className="w-10 h-10 text-sattva-orange group-hover:text-white" />
            </div>
          ...
          <div className="text-center group">
            <div className="w-20 h-20 bg-sattva-orange/10 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:bg-sattva-orange group-hover:scale-110 transition-all duration-300">
              <Star className="w-10 h-10 text-sattva-orange group-hover:text-white" />
            </div>
          ...
          <div className="text-center group">
            <div className="w-20 h-20 bg-sattva-orange/10 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:bg-sattva-orange group-hover:scale-110 transition-all duration-300">
              <Phone className="w-10 h-10 text-sattva-orange group-hover:text-white" />
            </div>
