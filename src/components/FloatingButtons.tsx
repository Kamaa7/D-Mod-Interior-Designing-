  ...
  return (
    <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 flex flex-col gap-3 z-50" role="complementary" aria-label="Quick action buttons">
      ...
      <div className="flex items-center gap-3">
        <div className="rounded-full bg-white shadow-[0_10px_25px_rgba(13,25,48,0.12)] border border-slate-200 px-4 py-2 text-xs sm:text-sm font-medium text-slate-700">
          We're online. How may I assist you?
        </div>

        <Link to="/contact">
          <Button
            className="w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-[#F04D5D] hover:bg-[#e04554] text-white shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-110 active:scale-95 flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-[#F04D5D] focus:ring-offset-2"
